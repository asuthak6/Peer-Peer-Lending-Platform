        ...
        <div className="p-8 rounded-md w-80 z-20 backdrop-blur-sm bg-transparent border border-gray-600 mt-4">
          ...
          <form className="flex flex-col space-y-4">
            <div>
              ...
              <input type="text" className="w-full px-3 py-2 bg-transparent border border-gray-600 text-white rounded focus:outline-none" placeholder="Enter your username" />
            </div>
            <div>
            ...
            <button type="submit" className="w-full py-2 mt-4 bg-transparent border border-gray-600 hover:bg-gray-800 text-white rounded">Sign Up</button>
          </form>
          <div className="flex justify-center mt-4 text-sm">
            <Link to="/" className="text-blue-400 hover:underline">Already have an account? Login</Link>
          </div>
        </div>
      </div>
    </div>
